...
String path = "C:\\Users\\82107\\Desktop\\Workspace\\tovao-homepage-JSP\\tovao\\file"; // 이미지가 저장될 주소
String filename = request.getSession().getServletContext().getRealPath("/") + File.separator + "file";
